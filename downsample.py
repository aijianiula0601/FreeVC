...
def process(wav_name):
    ...
    if not os.path.exists(save_path1) or not os.path.exists(save_path2):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--in_dir", type=str, default="/home/Datasets/lijingyi/data/vctk/wav48_silence_trimmed/",
